...
a.out: main.o brain_class.o segment_class.o \
	...
	$(CC) -o a.out main.o brain_class.o segment_class.o logic_core.o image_package_class.o core_class.o $(LIBS) $(OPENCVLIBS) $(CXXFLAGS2)
...
data_package_class.o: image_package_class.cpp
